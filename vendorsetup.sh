...
patches_path="$build_root/device/NUBIA/X9180/patches/"
...
#sh device/NUBIA/X9180/update-overlay.sh

rm -f out/target/product/X9180/system/build.prop out/target/product/X9180/boot/root/default.prop out/target/product/X9180/recovery/root/default.prop
 
sh device/NUBIA/X9180/update-changelog.sh
